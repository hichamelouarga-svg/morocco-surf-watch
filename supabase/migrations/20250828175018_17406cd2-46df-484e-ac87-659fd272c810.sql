...
-- Create manual_news table if it doesn't exist
...
DROP POLICY IF EXISTS "Anyone can view manual news" ON public.manual_news;
DROP POLICY IF EXISTS "Only authenticated users can create manual news" ON public.manual_news;
DROP POLICY IF EXISTS "Only authenticated users can update manual news" ON public.manual_news;
DROP POLICY IF EXISTS "Only authenticated users can delete manual news" ON public.manual_news;
DROP POLICY IF EXISTS "Users can view their own roles" ON public.user_roles;
DROP POLICY IF EXISTS "Only authenticated users can manage roles" ON public.user_roles;
